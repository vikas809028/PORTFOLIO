...
export default function Grid() {
  ...
  return (
    <section id="about" className={isMobile ? "py-8 px-4" : "py-8"}>
      <div
        className={`
        w-full
        flex flex-col gap-6
      ...
      >
        ...
        >
          ...
          <div
            ...
            ${isMobile ? "p-5 gap-4" : "p-6 sm:p-7 lg:p-10 gap-5 lg:gap-6"}
          `}
          >
            <span
              className={`
            ...
            <div
              className={`flex flex-col ${isMobile ? "gap-3" : "gap-3"} flex-1`}
            >
              <p
                style={{
                  margin: 0,
              ...
              >
                ...
                platform serving lakhs of students. I own the backend, CI/CD
              ...
              >
                ...
                — building systems that are fast, maintainable, and always ship
                on time.
              </p>
            </div>
            ...
            <div
              className={`grid grid-cols-2 sm:flex sm:flex-wrap ${
                isMobile ? "gap-2 pt-4" : "gap-2 pt-4"
        ...
        <div
          className={`
          flex flex-col ${isMobile ? "gap-6" : "gap-4"}
        ...
        >
            ...
            >
              ...
              <div
                className={`flex-1 relative ${
                  isMobile ? "min-h-[120px]" : "min-h-[140px] sm:min-h-[160px] lg:min-h-[120px]"
                }`}
              >
                <GridGlobe />
              </div>
          ...
          <div style={baseCard}>
            <div
              className={`relative z-10 flex flex-col h-full ${
                isMobile ? "p-5 gap-3" : "p-5 lg:p-6 gap-3"
              }`}
            >
              <span
                style={{
              ...
              >
                {[
                  {
                    icon: "🎓",
                    text: "ITS Engineering College, AKTU",
                    accent: "#e2e8f0",
                  },
                  ...
                  <div
                    key={i}
                    style={{ display: "flex", alignItems: "center", gap: isMobile ? 8 : 8 }}
                  >
          ...
          <div style={{ ...baseCard, overflow: "hidden" }}>
            ...
            <div
              className={`relative z-10 flex flex-col sm:flex-row sm:items-center sm:justify-between h-full ${
                isMobile ? "p-5 gap-3" : "p-5 lg:px-6 gap-4"
              }`}
            >
              <div>
                <p
              ...
              <div className="relative flex-shrink-0 self-start sm:self-auto">
                ...
                >
                  <IoCopyOutline size={isMobile ? 13 : 13} />
        ...
        >
          ...
          />
          <div
            className={`relative z-10 flex flex-col sm:flex-row sm:items-center h-full ${
              isMobile ? "px-5 py-5 gap-3" : "px-6 py-5 lg:px-9 gap-4"
            }`}
          >
            <div
              className={`flex flex-col ${isMobile ? "gap-2" : "gap-2"} flex-1`}
            >
              ...
              >
                Real-time AI interviewer with instant feedback & performance
                tracking.
              </p>
            </div>
